...
('api_key_alpha_vantage', '', 'string', 'Alpha Vantage API Key for stock data', FALSE, NOW(), NOW()),
('api_key_finnhub', '', 'string', 'Finnhub API Key for stock data', FALSE, NOW(), NOW()),
('api_refresh_interval', '300', 'integer', 'Stock data refresh interval in seconds', TRUE, NOW(), NOW());
